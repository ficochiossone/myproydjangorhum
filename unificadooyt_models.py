...
class ServiciosInstitucion(models.Model):
    ...
    class Meta:
	db_table = 'serviciosxinstituciones'
...
class Complejidad_institucional(models.Model):
    nombre = models.CharField(max_length=32)
    sigla = models.CharField(max_length=8)
    registro_administrativo = models.ForeignKey(to = User, verbose_name = 'Registrado por')
    fecha_insert = models.DateField(auto_now = True)
    descripcion = models.TextField(blank = True)

    class Meta:
        verbose_name_plural = "Instituciones"
	db_table = 'institucpepiones'
...
class Distrito(models.Model):
    ...
    class Meta:
	db_table = 'distritos_municipales'
...
class Grupoterapeutico(models.Model):
    ...
    hospital = models.ForeignKey('Institucion',blank=True,null=True)
    inst_primer_nivel = models.ForeignKey('Centrosalud',blank=True,null=True)
    referente = models.CharField(max_length=64,blank=True,null=True)
    tipo = models.CharField(max_length=3,choices=TIPOCS,default = 'N/D')
    telefono = models.CharField(max_length=16,blank=True)
    domicilio = models.CharField(max_length=128,blank=True)
    comentarios = models.TextField(blank=True,null=True)
    integrantes = models.TextField(default='lista separada por comas')
...
class Categorizacion(models.Model):
    ...
    class Meta:
	db_table = 'categorias_profesionales'
...
class ItemLic_solicitado(models.Model):
    ...
    class Meta:
	db_table = 'items_licitacion_solicitados'
...
class ItemLic_ofrecido(models.Model):
    ...
    class Meta:
	db_table = 'items_licitacion_ofrecidos'
...
class Implante_comercial(models.Model):
    ...
    class Meta:
	db_table = 'implantes_comerciales'
...
class Grupo_estad_implante(models.Model):
	...
	class Meta:
	    db_table = 'grupo_estadistico_implante'
...
class Caso_pendiente(models.Model):
    ...
    class Meta:
        db_table = 'casos_pendientes'

class AgrupadorEstudios(models.Model):
    nombre=models.CharField(max_length=80)
    tipo=models.IntegerField()
    class Meta:
        db_table = 'agrupadoresestudios'
...
class ItemStockUtilizado(models.Model):
    ...
    class Meta:
	db_table = "items_stock_utilizados"
