    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True, null=True)),
                ('comentarios', models.CharField(blank=True, max_length=128, null=True)),
                ('especialidad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='entornos.Especialidad', verbose_name=b'Especialidad registrada')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especialidad_1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Esp1', to='entornos.Especialidad', verbose_name=b'Especialidad principal')),
                ('especialidad_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Esp2', to='entornos.Especialidad', verbose_name=b'Especialidad Dos')),
                ('especialidad_3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Esp3', to='entornos.Especialidad', verbose_name=b'Especialidad Tres')),
                ('especialidad_4', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Esp4', to='entornos.Especialidad', verbose_name=b'Especialidad Cuatro')),
