...
class Profesional(models.Model):
    ...
    matricula = models.CharField(max_length=16,blank=True,null=True,default='ABC123',verbose_name='Matricula')
...
### para listdisplayear en admin campo many to many va esta def 
    def display_esps(self):
        return ', '.join([ esp.codigo for esp in self.especialidad.all() ])
    display_esps.short_description = 'Especs'
    display_esps.allow_tags = True
...
class Reg_variable(models.Model):
    fecha_reg = models.DateTimeField(default=timezone.now,verbose_name='Resultado P Ex')   
...
class Consulta(models.Model):
    ...
    fecha_consulta = models.DateField(default=timezone.now,verbose_name='Fecha de Consulta')
