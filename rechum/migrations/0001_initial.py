...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tareasprev', models.TextField(default='Tareas previas', verbose_name='Nombre')),
                ('activo', models.BooleanField(default=True, verbose_name='Estado Asignacion TD')),
                ('codigo', models.CharField(default='Codigo....', max_length=32, verbose_name='Codigo')),
                ('tipo', models.CharField(choices=[('TEMPL', 'Temporal'), ('DFTVA', 'Definitiva'), ('EOBSN', 'En Observacion'), ('XTR', 'ExtraOrdinario')], default='TMPRL', max_length=12, verbose_name='Asignacion')),
                ...
                ('causaif', models.CharField(choices=[('GESTION', 'Gestion'), ('SALUD', 'Salud'), ('PRSNL', 'Personales'), ('XTR', 'ExtraOrdinario')], default='GESTION', max_length=32, verbose_name='Motivo')),
