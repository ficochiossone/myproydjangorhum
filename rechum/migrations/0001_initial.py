    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comentarios', models.TextField(blank=True, default='Solicito ..', max_length=256, null=True, verbose_name='Explicitacion ')),
                ('fecha_registro', models.DateField(auto_now=True)),
                ('areadep', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='entornos.Areadependencia', verbose_name='Area Responsable')),
                ('espec', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='entornos.Especialidad', verbose_name='Especialidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.CharField(default='Codigo....', max_length=32, verbose_name='Codigo')),
                ('tipo', models.CharField(choices=[('TEMPL', 'Temporal'), ('DFTVA', 'Definitiva'), ('EOBSN', 'En Observacion'), ('XTR', 'ExtraOrdinario')], default='SELECCION INTERNA MUNICIPAL', max_length=12, verbose_name='T dif Asignada')),
                ...
                ('causaif', models.CharField(choices=[('GESTION', 'Gestion'), ('SALUD', 'Salud'), ('PRSNL', 'Personales'), ('XTR', 'ExtraOrdinario')], default='GESTION', max_length=32, verbose_name='MOTIVO PRINCIPAL')),
                ('detallecambiox', models.CharField(max_length=288, verbose_name='Razones para Cambio')),
                ('detalle', models.TextField(blank=True, max_length=256, null=True, verbose_name='Tareas Actuales')),
                ('fecha_registro', models.DateField(auto_now=True)),
                ('areadep', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='entornos.Areadependencia', verbose_name='Area Responsable')),
                ('espec', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='entornos.Especialidad', verbose_name='Especialidad')),
                ('instdst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='insdst', to='entornos.Institucion', verbose_name='Inst destino')),
                ('institucion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='insog', to='entornos.Institucion', verbose_name='Inst origen')),
                ('profesion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='entornos.Profesion', verbose_name='Profesion')),
            ],
            options={
                'db_table': 'asgtdifs',
